...
@Packet(PacketType.generaldata) void handleGeneralData(GameClient client, DataPacket packet) {
	...
	switch (generalData.action) {
		...
		case DataAction.changeDirection: handleChangeDirection(client, generalData); break;
		case DataAction.changeAction: handleChangeAction(client, generalData); break;
		// </change.d>
